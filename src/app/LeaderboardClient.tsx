...
export default function LeaderboardClient({ initialUsers }: LeaderboardClientProps) {
  ...
  // Sync users update from prop changes (e.g. after router.refresh())
  useEffect(() => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {users.length === 0 ? (
        ...
        <>
          {/* Podium Area (Only shown when not searching and sorting by score/questions) */}
          {searchQuery === '' && sortedUsers.length >= 1 && (
              ...
              <div className={styles.modalBody}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input 
                    type="password" 
                    id="secret-passkey"
                    placeholder="Enter passkey to add profile"
                    value={secretKey}
                    ...
                    className={styles.modalInput}
                  />
                  <small className={styles.formTip}>Required. Ask the admin for the secret passkey.</small>
                </div>
              </div>
